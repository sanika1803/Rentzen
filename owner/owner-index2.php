...
<body>
 ...
 <div class="container-fluid">
  <ul class="nav nav-pills nav-justified">
    ...
    <li class="messages" style="background-color: #FAC0E6"><a data-toggle="pill" href="#menu4">Messages</a></li>
    <li class="add-property" style="background-color: #FAF0E6"><a data-toggle="pill" href="#menu1">Add Property</a></li>
    <li class="view-property" style="background-color: #FFFACD"><a data-toggle="pill" href="#menu2">View Property</a></li>
    <li class="update-property" style="background-color: #FFFAF0"><a data-toggle="pill" href="#menu3">Update Property</a></li>
    <li class="booked-property" style="background-color: #FFFACD"><a data-toggle="pill" href="#menu6">Booked Property</a></li>
  ...
  <div class="modal fade" id="myModal" role="dialog">
    ...
    <div id="menu4" class="tab-pane fade in messages">
      <div class="container">
...
<div id="<?php echo $rows["full_name"]; ?>" class="tabcontent">
 ...
 <!-- Modal -->
  <div class="modal fade" id="add-property" role="dialog">
    <div class="modal-dialog">
    ...
    <div id="menu2" name="menu2" class="tab-pane fade in vi">
